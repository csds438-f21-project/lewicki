...
class MessageKind(Enum):
    ...
    CALL: Message contains method name and arguments as a dict
        {'name': <method_name>, ['args': <args>], ['kwargs': <kwargs>],
        ['return': True]}
    ...
    SET: Message contains variable name and value as a dict
...
class Message:
    __slots__ = ('id', 'prev_id', 'sender', 'receiver', 'kind', 'data')
    ...
    def __init__(
            ...
            *,
            ...
            prev_id: Optional[Hashable] = None):
        self.data = data
    ...
    def __repr__(self):
        ...
        sequence = f'{self.prev_id} -> {self.id}'
